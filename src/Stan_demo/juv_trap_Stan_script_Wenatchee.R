...
screw_trap_dat$chiw$chiw_catch$week<-as.numeric(format(screw_trap_dat$chiw$chiw_catch$EndDat,"%W"))#add week
...
screw_trap_dat$chiw$chiw_effic$week<-as.integer(format(screw_trap_dat$chiw$chiw_effic$Date2,"%W"))
