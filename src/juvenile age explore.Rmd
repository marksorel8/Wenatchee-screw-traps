...
plot(c(50,knots+5,smolt_max_DOY),c(first_point_y,break_ln,last_point_y),type="l",col="red") 
...
table(interrogation$pred_age)

table(interrogation$pred_Mark_to_mig,interrogation$Mark_to_mig)
