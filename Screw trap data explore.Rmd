...
#functions to make and plot time series
source(here("src","ts_and_plotting_funcs.R"))

#make and plot TS
Chiw_fry_ts<-make_ts(screw_trap_dat$chiw$chiw_catch$EndDate,screw_trap_dat$chiw$chiw_catch$fryCatch,"Chiwawa River FRY",plot=TRUE,plotDis = TRUE,dis_dates =screw_trap_dat$chiw$chiwDis$Date ,dis_vals=screw_trap_dat$chiw$chiwDis$X_00060_00003 )
